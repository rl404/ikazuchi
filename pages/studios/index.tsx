...
import { Context, DispatchContext, defaultCtx, reducer } from '@/components/contexts/StudioContext';
...
export default function StudiosPage({ name, sort }: { name: string; sort: string }) {
	return (
		<>
			<Head
				title="Studios"
