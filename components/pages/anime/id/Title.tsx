    ...
    >
      <div className="grid gap-1">
        ...
        {anime.alternative_titles.synonyms.length > 0 && (
          <motion.div
            title="synonym titles"
            className="grid text-sm text-secondary"
            initial="closed"
      ...
      <div className="hidden grid-cols-3 gap-2 lg:grid">
        <div
          ...
          title="average score"
        >
          <div className="pointer-events-none text-sm text-primary">Score</div>
        ...
        <div
          ...
          title="global rank"
        >
          <div className="pointer-events-none text-sm text-primary">Rank</div>
          <div className="text-4xl">
